...
global.enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '😻 𝑺𝒖𝒑𝒆𝒓 𝑮𝒂𝒕𝒐𝑩𝒐𝒕', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
